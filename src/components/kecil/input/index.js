...
const Input = ({ placeholder, textarea, width, height, fontSize, label, value, secureTextEntry, keyboardType, onChangeText, disabled }) => {
    if (textarea) {
        return (
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput style={styles.input(width, height, fontSize)}
                value={value} placeholder={placeholder} secureTextEntry={secureTextEntry} keyboardType={keyboardType}
